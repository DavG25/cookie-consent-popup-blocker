  ...
  cookies: [
    {
      ...
      name: 'SOCS',
      value: 'CAESHAgCEhJnd3NfMjAyNjA2MTEtMF9SQzEaAmVuIAEaBgiAgb3RBg', // Equals to 'Reject all'
    ...
    },
    {
      ...
      validRegex: /^C.*/, // Regex to check against to consider the cookie valid
      name: 'SOCS',
      value: 'CAESNQgDEitib3FfaWRlbnRpdHlmcm9udGVuZHVpc2VydmVyXzIwMjYwNjEwLjA1X3AwGgJlbiACGgYIgIG90QY', // Equals to 'Reject all'
      maxAge: generateCookieMaxAge(395),
      httpOnly: false,
      path: '/',
      sameSite: 'Lax',
